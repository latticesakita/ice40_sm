...
*******************************************************************************/
(* ORIG_MODULE_NAME="system1", LATTICE_IP_GENERATED="1" *) module system1 (HCLK, 
        HRESETn, 
        HADDR, 
        HBURST, 
        HTRANS, 
    ...
    system1_ipgen_ahb_spsram_sm ahb_spsram_sm_inst (.HCLK(HCLK), 
                .HRESETn(HRESETn), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
                .HTRANS(HTRANS[1:0]), 
...
module system1_ipgen_ahb_spsram_sm (
    input HCLK, 
    input HRESETn, 
    input [31:0] HADDR, 
    input [2:0] HBURST, 
    ...
    assign sram_addr = (sram_re ? HADDR[15:2] : r_sram_addr) ; 
