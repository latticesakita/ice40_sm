...
*******************************************************************************/
(* ORIG_MODULE_NAME="data_if", LATTICE_IP_GENERATED="1" *) module data_if (HCLK, 
        HRESETn, 
        HADDR, 
        HBURST, 
        HTRANS, 
    ...
    data_if_ipgen_ahb_spsram_if ahb_spsram_if_inst (.HCLK(HCLK), 
                .HRESETn(HRESETn), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
                .HTRANS(HTRANS[1:0]), 
...
module data_if_ipgen_ahb_spsram_if (
    input HCLK, 
    input HRESETn, 
    input [31:0] HADDR, 
    input [2:0] HBURST, 
