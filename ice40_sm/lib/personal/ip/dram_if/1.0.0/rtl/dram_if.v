...
*******************************************************************************/
(* ORIG_MODULE_NAME="dram_if", LATTICE_IP_GENERATED="1" *) module dram_if (HCLK, 
        HRESETn, 
        HADDR, 
        HBURST, 
        HTRANS, 
    ...
    dram_if_ipgen_ahb_spsram_nano ahb_spsram_nano_inst (.HCLK(HCLK), 
                .HRESETn(HRESETn), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
                .HTRANS(HTRANS[1:0]), 
...
module dram_if_ipgen_ahb_spsram_nano (
    input HCLK, 
    input HRESETn, 
    input [31:0] HADDR, 
    input [2:0] HBURST, 
