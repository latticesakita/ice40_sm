...
*******************************************************************************/
(* ORIG_MODULE_NAME="spsram_if_ahb_sm_inst", LATTICE_IP_GENERATED="1" *) module spsram_if_ahb_sm_inst (HCLK, 
        HRESETn, 
        HADDR, 
        HBURST, 
        HTRANS, 
    ...
    spsram_if_ahb_sm_inst_ipgen_ahb_spsram_sm ahb_spsram_sm_inst (.HCLK(HCLK), 
                .HRESETn(HRESETn), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
                .HTRANS(HTRANS[1:0]), 
...
module spsram_if_ahb_sm_inst_ipgen_ahb_spsram_sm (
    input HCLK, 
    input HRESETn, 
    input [31:0] HADDR, 
    input [2:0] HBURST, 
