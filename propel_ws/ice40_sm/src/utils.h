...
#define CONFIG_DEFAULT_M_HZ CPU_M_FREQUENCY
#else
#if IS_NANO_CORE
...
#if (defined CPU_M_FREQUENCY) && (defined CPU_INST_0_PICTIMER_START_ADDR)
#define SYSCLK_KHZ (CPU_M_FREQUENCY * 1000)
#define TIMER0_INST_BASE_ADDR (CPU_INST_0_PICTIMER_START_ADDR + 0x400)
